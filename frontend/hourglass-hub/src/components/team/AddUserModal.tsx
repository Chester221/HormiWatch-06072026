...
export function AddUserModal({ open, onOpenChange, onSuccess }: AddUserModalProps) {
  ...
  const validateCedula = (value: string, type: string) => {
    ...
    if (cleanValue.length < 7 || cleanValue.length > 8) return false;
    return true;
  };
  ...
  const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (numbers && !numbers.startsWith("+58")) {
      if (numbers.startsWith("58")) numbers = "+" + numbers;
      else if (numbers.startsWith("0")) numbers = "+58" + numbers.slice(1);
      else numbers = "+58" + numbers;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email.trim()) { toast.error("El correo electrónico es requerido"); return; }
    if (!validateEmail(email)) { toast.error("Ingresa un correo electrónico válido"); return; }
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            ...
            <Input
              ...
              className={`bg-muted/30 border-border focus:border-blue-500 h-9 rounded-lg text-sm ${errors.fullName ? "border-red-500" : ""}`}
              required
            />
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Input
                ...
                className={`bg-muted/30 border-border focus:border-blue-500 h-9 rounded-lg text-sm flex-1 ${errors.cedula ? "border-red-500" : ""}`}
                inputMode="numeric"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <Input
              ...
              className={`bg-muted/30 border-border focus:border-blue-500 h-9 rounded-lg text-sm ${errors.email ? "border-red-500" : ""}`}
              required
            />
          ...
          <div>
            ...
            <Input
              ...
              className={`bg-muted/30 border-border focus:border-blue-500 h-9 rounded-lg text-sm ${errors.password ? "border-red-500" : ""}`}
              required
            />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Input
                ...
                className="bg-muted/30 border-border focus:border-blue-500 h-9 rounded-lg text-sm"
              />
            </div>
          </div>
